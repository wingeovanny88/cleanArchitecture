...
Este proyecto está organizado siguiendo los principios de Domain Driven Design (DDD) y Clean/Hexagonal Architecture. La separación en capas permite mantener la lógica de negocio independiente de los detalles técnicos y adaptadores externos, facilitando el mantenimiento, las pruebas y la escalabilidad.
